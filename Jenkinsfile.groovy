...
node () {
    ...
    stage ("BUILD") {
        ...
        sh "cp spring-boot-mustang/spring-boot-tests/spring-boot-smoke-tests/spring-boot-smoke-test-web-ui/target/spring-boot-smoke-test-web-ui-2.2.1.BUILD-SNAPSHOT.jar ./spring-project.1.0.${env.BUILD_NUMBER}.jar"
        sh "ls -lh"
    }
